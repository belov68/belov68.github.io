...
$CLOAKING['WHITE_PAGE'] = 'https://vk.com';//PHP или HTML файл для ботов и модераторов
$CLOAKING['OFFER_PAGE'] = 'https://vk.com';//PHP или HTML файл с оффером/лендингом для пользователей на которых таргетируемся.
...
$CLOAKING['API_SECRET_KEY'] = 'v14d039d26ec8d49399a72f78db83bb7c0';// ключ доступа к API.
/*********************************************/
